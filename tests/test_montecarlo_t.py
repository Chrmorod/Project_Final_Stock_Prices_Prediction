...
from infra.mlops.predict_stock.transformers.montecarlo_t import transform  # noqa: E402
...
@patch(
    "infra.mlops.predict_stock.transformers.montecarlo_t.tempfile.NamedTemporaryFile"
)
...
def test_transform_montecarlo(
    mock_mlflow, mock_pickle, mock_tempfile, mock_remove, fake_price_data
):
    mock_tmp = MagicMock()
